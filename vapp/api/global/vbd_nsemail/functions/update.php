...
$JSON['rq_fields']=EngineBuild:: RequiredFields ($METHOD,['nsemail_name','nsemail_email','nsemail_date'] );
...
$Vbd_nsemailModel = new Vbd_nsemailModel();
    ...
    $result= $Vbd_nsemailModel->update(['nsemail_id'=> $nsemail_id,'nsemail_name'=> $nsemail_name,'nsemail_email'=> $nsemail_email,'nsemail_date'=> $nsemail_date]);

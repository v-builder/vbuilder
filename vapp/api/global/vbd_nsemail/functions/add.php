...
$JSON['rq_fields']=EngineBuild:: RequiredFields ($METHOD,['nsemail_name','nsemail_email',] );
...
$Vbd_nsemailModel = new Vbd_nsemailModel() ;
    ...
    $result= $Vbd_nsemailModel->add(['nsemail_name'=> $nsemail_name,'nsemail_email'=> $nsemail_email,'nsemail_date'=> $nsemail_date]);

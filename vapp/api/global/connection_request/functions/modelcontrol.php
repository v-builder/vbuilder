...
$Connection_requestModel = new Connection_requestModel() ;
    ...
    $result= $Connection_requestModel->modelControl(['cr_id'=> $cr_id,'from_user_id'=> $from_user_id,'to_user_id'=> $to_user_id,'cr_date'=> $cr_date,'cr_date_response'=> $cr_date_response,'cr_state'=> $cr_state,'cr_response'=> $cr_response]);

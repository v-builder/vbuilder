...
$JSON['rq_fields']=EngineBuild:: RequiredFields ($METHOD,['ulevel_id','ulevel_name','ulevel_desc'] );
...
if(
    ...
    $result= $Vbd_user_levelModel->modelControl(['ulevel_id'=> $ulevel_id,'ulevel_name'=> $ulevel_name,'ulevel_desc'=> $ulevel_desc]);

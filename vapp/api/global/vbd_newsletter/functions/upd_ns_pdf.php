                ...
                function upd_ns_pdf($user_idTmp){
                ...
                if(is_uploaded_file($_FILES["ns_pdf"]["tmp_name"][0])){
                foreach ($_FILES["ns_pdf"]["name"] as $f => $name) {
                $jsonUP["start"]=true;
                $jsonUP["count_files"]++;
                $name = $_FILES["ns_pdf"]["name"][$f];
                $size = $_FILES["ns_pdf"]["size"][$f];
                $type = $_FILES["ns_pdf"]["type"][$f];
                $tmp_name = $_FILES["ns_pdf"]["tmp_name"][$f];
                ...
                //        echo "The file ". basename( $_FILES["ns_pdf"]["name"]). " has been uploaded.";
                }
                $files[]= $file;
                // end of foreach
                }

...
$JSON['rq_fields']=EngineBuild:: RequiredFields ($METHOD,['ns_id','ns_date','ns_subject','ns_body','ns_altbody','ns_cleanbody','ns_attach','user_id','ns_cover','ns_pdf'] );
...
exit;
            ...
            $ns_date=EngineBuild::GetField ($METHOD,'ns_date');
...
$Vbd_newsletterModel = new Vbd_newsletterModel() ;
    ...
    $result= $Vbd_newsletterModel->modelControl(['ns_id'=> $ns_id,'ns_date'=> $ns_date,'ns_subject'=> $ns_subject,'ns_body'=> $ns_body,'ns_altbody'=> $ns_altbody,'ns_cleanbody'=> $ns_cleanbody,'ns_attach'=> $ns_attach,'user_id'=> $user_id,'ns_cover'=> $ns_cover,'ns_pdf'=> $ns_pdf]);

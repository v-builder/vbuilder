                ...
                function upd_ns_attach($user_idTmp){
                ...
                if(is_uploaded_file($_FILES["ns_attach"]["tmp_name"][0])){
                foreach ($_FILES["ns_attach"]["name"] as $f => $name) {
                $jsonUP["start"]=true;
                $jsonUP["count_files"]++;
                $name = $_FILES["ns_attach"]["name"][$f];
                $size = $_FILES["ns_attach"]["size"][$f];
                $type = $_FILES["ns_attach"]["type"][$f];
                $tmp_name = $_FILES["ns_attach"]["tmp_name"][$f];
                ...
                //        echo "The file ". basename( $_FILES["ns_attach"]["name"]). " has been uploaded.";
                }
                $files[]= $file;
                // end of foreach
                }

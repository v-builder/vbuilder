...
$JSON['rq_fields']=EngineBuild:: RequiredFields ($METHOD,['nsmail_id','nsmail_date','ns_id','nsemail_id','ns_state'] );
...
exit;
            ...
            $nsmail_id=EngineBuild::GetField ($METHOD,'nsmail_id');
...
$Vbd_ns_mailModel = new Vbd_ns_mailModel() ;
    ...
    $result= $Vbd_ns_mailModel->modelControl(['nsmail_id'=> $nsmail_id,'nsmail_date'=> $nsmail_date,'ns_id'=> $ns_id,'nsemail_id'=> $nsemail_id,'ns_state'=> $ns_state]);

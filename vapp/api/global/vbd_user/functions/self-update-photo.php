...
///
            ...
            $size = $_FILES['file']['size'][$f];
            $type = $_FILES['file']['type'][$f];
            $tmp_name = $_FILES['file']['tmp_name'][$f];
...
//                        $result=$Vbuilder_uploadModel->deleteBaseByPath($final_location_db);
                    ...
                    $result= $Vbd_uploadModel->add([
                        'upload_date'=> $date,
                        'upload_privacy'=> $privacy,
                        'file_type'=> $type,
                        'file_path'=> $final_location_db,
                        'file_name'=> $file['final_name_no_ext'],
                        'file_ext'=> $extensaoAnexo,
                        'file_size'=> $size,
                        'user_id'=> $user_id]);
                ...
                if(!$result['result']&&$uploaded){
                    if(file_exists($final_location_db)){
...
if($json['count_success']>0 && $upload_id_!=0){

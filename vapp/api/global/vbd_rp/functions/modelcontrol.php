...
$Vbd_rpModel = new Vbd_rpModel() ;
    ...
    $result= $Vbd_rpModel->modelControl(['rp_id'=> $rp_id,'rp_email'=> $rp_email,'user_id'=> $user_id,'rp_code'=> $rp_code,'rp_date'=> $rp_date,'rp_date_exp'=> $rp_date_exp,'rp_state'=> $rp_state]);

...
$JSON['rq_fields']=EngineBuild:: RequiredFields ($METHOD,['usp_id','vbd_at_id','usp_label_value','usp_type_value','user_bdate','phone_code','phone_number','phone_number_alt','phone_shown','gender','about','bio'] );
...
exit;
            ...
            $usp_id=EngineBuild::GetField ($METHOD,'usp_id');
...
$Vbd_user_pdataModel = new Vbd_user_pdataModel() ;
    ...
    $result= $Vbd_user_pdataModel->modelControl(['usp_id'=> $usp_id,'vbd_at_id'=> $vbd_at_id,'usp_label_value'=> $usp_label_value,'usp_type_value'=> $usp_type_value,'user_bdate'=> $user_bdate,'phone_code'=> $phone_code,'phone_number'=> $phone_number,'phone_number_alt'=> $phone_number_alt,'phone_shown'=> $phone_shown,'gender'=> $gender,'about'=> $about,'bio'=> $bio]);

...
if(
    ...
    $result= $Vbd_uploadModel->update(['upload_id'=> $upload_id,'upload_date'=> $upload_date,'upload_privacy'=> $upload_privacy,'file_type'=> $file_type,'file_path'=> $file_path,'file_name'=> $file_name,'file_ext'=> $file_ext,'file_size'=> $file_size,'user_id'=> $user_id]);

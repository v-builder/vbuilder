...
$JSON['rq_fields']=EngineBuild:: RequiredFields ($METHOD,['upload_date','upload_privacy','file_type','file_path','file_name','file_ext','file_size'] );
...
if(
    ...
    $result= $Vbd_uploadModel->add(['upload_date'=> $upload_date,'upload_privacy'=> $upload_privacy,'file_type'=> $file_type,'file_path'=> $file_path,'file_name'=> $file_name,'file_ext'=> $file_ext,'file_size'=> $file_size,'user_id'=> $user_id]);

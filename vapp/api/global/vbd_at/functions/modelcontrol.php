...
$JSON['rq_fields']=EngineBuild:: RequiredFields ($METHOD,['vbd_at_id','vbd_at_type','vbd_at_desc'] );
...
$Vbd_atModel = new Vbd_atModel() ;
    ...
    $result= $Vbd_atModel->modelControl(['vbd_at_id'=> $vbd_at_id,'vbd_at_type'=> $vbd_at_type,'vbd_at_desc'=> $vbd_at_desc]);

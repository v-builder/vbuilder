...
define('VBD_PG_TITLE',"Sent Email | Newsletter");
            ...
            <div class="col-lg-12c grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        EngineBuild::BuildBindingProcessorScope(EngineBuild::getAppRoot()."view/vbd_ns_mail/root.php");
...
<script type="text/javascript" src="<?php echo EngineBuild::getVbdTemplateUrl(); ?>/view/vbd_ns_mail/controller.js"></script>

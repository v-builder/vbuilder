...
define('VBD_PG_TITLE',"User Level Management");
            ...
            <div class="col-lg-12c grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        EngineBuild::BuildBindingProcessorScope(EngineBuild::getAppRoot()."view/vbd_user_level/root.php");
                        ?>
                    </div>
                </div>
            </div>
...
<script type="text/javascript" src="<?php echo EngineBuild::getVbdTemplateUrl(); ?>/view/vbd_user_level/controller.js"></script>
